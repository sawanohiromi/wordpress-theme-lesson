...
function sakura_theme_link(){
    wp_enqueue_style('sp-css',get_template_directory_uri().'/css/style/_sp.css',array(),'1.0.0','screen and ( max-width:768px )');
    wp_enqueue_style('pc-css',get_template_directory_uri().'/css/style/_pc.css',array(),'1.0.0','screen and ( min-width:769px )');
